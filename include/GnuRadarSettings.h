...
namespace gnuradar{
   ...
   struct GnuRadarSettings {
      ...
      public:
      GnuRadarSettings() : 
         whichBoard ( 0 ), decimationRate ( 8 ), numChannels ( 1 ), mux ( -1 ), 
         mode ( 0 ), fUsbBlockSize ( 0 ), fUsbNblocks ( 0 ), fpgaFileName ( "" ),
         firmwareFileName ( "" ), tuningFrequency ( 4, 0.0 ), ddcPhase ( 4, 0.0 ), 
         clockRate ( 64e6 ) {}
