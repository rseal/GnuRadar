...
public:
    ...
    virtual void PrintError() {
        std::cout << "Exception Thrown (from Parser Class)" << std::endl;
    }
};
...
public:
    virtual void PrintError() {
        std::cout << "File could not be opened (from Parser Class)" << std::endl;
    }
};
...
public:
    virtual void PrintError() {
        std::cout << "Key/Value pair does not exist (from Parser Class)" << std::endl;
    }
};
