...
public:
    ...
    const std::string Label() {
        return dataWindow_.name;
    }

    void Start ( const int& start );
    const int Start() {
        return dataWindow_.start;
    }

    void Size ( const int& size );
    const int Size() {
        return dataWindow_.size;
    }

    void Units ( const int& units );
    const int Units() {
        return dataWindow_.units;
    }

    const int& ID() {
        return dataWindow_.id;
    }

    const bool WindowValid() {
        return dataWindow_.start >= 0 && dataWindow_.size >= 0;
    }

    DataWindowStruct& DataWindowRef() {
        return dataWindow_;
    }
