...
public:
    ...
    virtual void PrintError() {
        cout << "Exception Thrown (from Parser Class)" << endl;
    }
};
...
public:
    virtual void PrintError() {
        cout << "File could not be opened (from Parser Class)" << endl;
    }
};
...
public:
    virtual void PrintError() {
        cout << "Key/Value pair does not exist (from Parser Class)" << endl;
    }
};
