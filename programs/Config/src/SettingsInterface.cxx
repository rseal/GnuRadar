...
{
    settingsCompute_ = shared_ptr<SettingsCompute>(new SettingsCompute);
    ...
    sampleRate_ = shared_ptr<Fl_Float_Input>(new Fl_Float_Input(x0, y0, w0, h1, "Sample Rate"));
    ...
    units1_ = shared_ptr<Fl_Output>(new Fl_Output(x0+65,y0, 40, h1));
    units1_->value("MHz");
    ...
    channels_ = shared_ptr<Fl_Choice>( new Fl_Choice(x0+sp2, y0, w0, h1, "Channels"));
    ...
    decimation_ = shared_ptr<Fl_Value_Slider>(new Fl_Value_Slider(x0, y0+sp1, w1+25, h1, "Decimation"));
    ...
    bandwidth_ = shared_ptr<Fl_Output>(new Fl_Output(x0+sp2, y0+sp1, w0, h1, "Bandwidth"));
    bandwidth_->value("8");
    ...
    units2_ = shared_ptr<Fl_Output>(new Fl_Output(x0+sp2+65,y0+sp1, 40, h1));
    units2_->value("MHz");
